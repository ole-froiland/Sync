        ...
        <div className="flex-1 min-w-0">
          ...
          {post.source_url && (
            <a
              ...
              className="inline-flex items-center gap-1.5 mt-2 text-xs text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium"
            >
