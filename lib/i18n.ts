...
const pairs = [
  ...
  ['Both open this repository straight from your projects folder.', 'Begge åpner dette repoet rett fra prosjektmappen din.'],
  ['Change folder', 'Endre mappe'],
  ['Choose folder', 'Velg mappe'],
  ['Where do you keep projects on this computer?', 'Hvor lagrer du prosjekter på denne maskinen?'],
  ['Sync remembers this folder and opens every repository from it, in both Codex and Claude Code. You only pick it once.', 'Sync husker denne mappen og åpner alle repoer derfra, både i Codex og Claude Code. Du velger den bare én gang.'],
  ['Projects folder', 'Prosjektmappe'],
  ['This repository opens from', 'Dette repoet åpnes fra'],
  ['Enter a full path that starts with a slash.', 'Skriv inn en full sti som starter med skråstrek.'],
  ['Not sure of the path? In Finder, right-click the folder, hold Option and choose Copy as Pathname.', 'Usikker på stien? Høyreklikk mappen i Finder, hold inne Tilvalg (Option) og velg «Kopier som banenavn».'],
  ['Brand new repository? It has to be on your computer before either app can open it. Run this inside your projects folder first.', 'Helt nytt repo? Det må ligge på maskinen din før noen av appene kan åpne det. Kjør denne inne i prosjektmappen din først.'],
  ['Save and open', 'Lagre og åpne'],
